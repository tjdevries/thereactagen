    ...
    (body
       [ div
           ...
           [ div
               ...
               [ Card.make
                   ~a:[ a_class [ "w-full" ] ]
                   [ Typography.make ~as_elt:H1 ~size:Large [ txt "Typography" ]
                   ; div
                       ...
                       ; ul
                           ...
                           [ li
                               [ Typography.make ~font_style:Mono [ txt "Mono" ]
                               ]
                           ; li
                               [ Typography.make
                                   ~font_style:Serif
                           ...
                           ; li
                               [ Typography.make ~font_style:Sans [ txt "Sans" ]
                               ]
                           ]
                       ]
                   ]
               ; Card.make
                   ~a:[ a_class [ "w-full" ] ]
                   [ Typography.make ~as_elt:H1 ~size:Large [ txt "Buttons" ] ]
               ; Card.make
                   ~a:[ a_class [ "w-full" ] ]
